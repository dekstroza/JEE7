...
@Singleton
public class TokenServiceConsumer {

    private static final Logger log = LoggerFactory.getLogger(TokenServiceConsumer.class);

    @Inject
    private KafkaMessageConsumer kafkaMessageConsumer;

    @Inject
    private TokenServiceProducer processor;
    ...
    public void startSubscriber() {
        mes.execute(() -> {
            try {
                kafkaMessageConsumer.getConsumer().subscribe(Arrays.asList("reg-in"));
