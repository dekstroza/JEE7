...
public class SyLImplementationTest extends BaseTestImplementation {
    ...
    private static final String REQUEST_URL = "http://localhost:8080/websockets-war-syl/logger/insert";
    ...
    public static WebArchive createSylDeployment() {
        ...
        war.addPackage("org.dekstroza.logger.partitioning.impl.synchronizedlist");
        return war;
